  ...
  return (
    <div className='sidebar-container'>
        ...
        <ul className='sidebar-list'>
            ...
            <li><NavLink to='/wireless'><i className="bi bi-wifi"></i> Wireless</NavLink></li>
            <li><NavLink to='/access-points'><i className="bi bi-router-fill"></i> Access Points</NavLink></li>
            <li><NavLink to='/docs'><i className="bi bi-journals"></i> Docs</NavLink></li>
